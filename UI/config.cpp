...
class CfgInGameUI
{
	...
	class Cursor
	{
		...
		freeLookActionColor[]={0.89999998,0.89999998,0.89999998,0.40000001};
		freeLookActionColorSelected[]={0.23999999,0.87,0,0.80000001};
		freeLookActionColorAvailable[]=
		{
			"(profilenamespace getvariable ['IGUI_TEXT_RGB_R',0])",
			"(profilenamespace getvariable ['IGUI_TEXT_RGB_G',1])",
			"(profilenamespace getvariable ['IGUI_TEXT_RGB_B',1])",
